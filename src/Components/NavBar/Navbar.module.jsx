    ...
    <>
      <div className={styles.Main_Header}>
        ...
        <div className={styles.links}>
          <Link onClick={() => getQ("Dresses")} to="/cat">
            Womens Ethic
          </Link>
          <NavbarFloat
            key="women ethic"
          ...
          />
          <Link onClick={() => getQ("Jewellery")} to="/cat">
          ...
          <Link onClick={() => getQ("Mens Top Were")} to="/cat">
            Men
          </Link>
          <NavbarFloat
            key="Mens Top "
          ...
          <Link onClick={() => getQ("Beauty and health")} to="/cat">
            Beauty & Health
          </Link>
          <NavbarFloat
            key="Beauty n"
          ...
          <Link onClick={() => getQ("Bags and Footwear")} to="/cat">
            Bags and Footwear
          </Link>
          <NavbarFloat
            key="Bags and"
          ...
          />
          <Link onClick={() => getQ("Home and Kitchen")} to="/cat">
            Home & Kitchen
          </Link>
          <NavbarFloat
          ...
          <Link onClick={() => getQ("electronics")} to="/cat">
            Electronics
          </Link>
          <NavbarFloat
            key="Home"
